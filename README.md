...
New Features:
  - Dot Product: used to Vector3.Dot to determine JohnLemon's location in relation to Gargoyle GameObjects within my playerMovement script (also utilizing normalization). 
